                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 mt-12">
                    ...
                    >
                        ...
                        <p className="text-base xs:text-lg text-secondryColor">
                            ...
                            acquired the skills and knowledge necessary to make
                            your project a success. I like to create sketches
                            and I'm always curious to learn more about new
                            technologies and creative coding.
                            <br />
                            My field of interest are building new Web
                            Technologies and Products and also in areas related
                            to Deep Learning and Natural Launguage Processing.
                            <br />I have clear, logical mind with a practical
                            approach to problem-solving and a drive to see
                            things through to completion. I have work experience
                            in multiple project and clone project with team
                            collaboration.
                        </p>
                    </motion.div>
                </div>
