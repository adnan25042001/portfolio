...
const Home = () => {
    return (
        <section
            className={`bg-[url(./assets/images/star-background.jpg)] bg-no-repeat bg-cover bg-center bg-fixed relative pt-[120px] home h-full min-h-full sm:min-h-full sm:h-[100vh]`}
        >
            <div
